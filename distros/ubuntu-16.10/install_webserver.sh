...
InstallWebServer() {
  ...
  if [ "$CFG_WEBSERVER" == "apache" ]; then
	...
	apt-get -yqq install apache2 apache2-doc apache2-mpm-prefork apache2-utils libapache2-mod-php7.0 libapache2-mod-fastcgi libapache2-mod-fcgid apache2-suexec libapache2-mod-passenger libapache2-mod-python libexpat1 ssl-cert libruby > /dev/null 2>&1
	echo -e "[${green}DONE${NC}]\n"
	echo -n "Installing PHP and Modules... "
	apt-get -yqq install php7.0 php7.0-common php7.0 php7.0-common php7.0-dev php7.0-gd php7.0-mysqlnd php7.0-imap php7.0-cli php7.0-cgi php-pear php-auth php7.0-fpm php7.0-mcrypt php-imagick php7.0-curl php7.0-intl php-memcached php7.0-pspell php7.0-recode php7.0-snmp php7.0-sqlite php7.0-tidy php7.0-xmlrpc php7.0-xsl > /dev/null 2>&1
	echo -e "[${green}DONE${NC}]\n"
  ...
  if [ "$CFG_XCACHE" == "yes" ]; then
	...
	service nginx start 
	apt-get -yqq install php7.0 php7.0-common php7.0-gd php7.0-mysql php7.0-imap php7.0-curl php7.0-intl php7.0-pspell php7.0-recode php7.0-sqlite3 php7.0-tidy php7.0-xmlrpc php7.0-xsl php-gettext php7.0-zip php7.0-mbstring php-pear php-auth php-apcu > /dev/null 2>&1
	...
	#sed -i "s/#/;/" /etc/php7.0/conf.d/ming.ini
